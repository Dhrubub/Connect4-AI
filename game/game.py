...
class Player:
    ...
    def take_turn(self, board) -> Union[int, str]:
        if self.type == PlayerType.human:
            return input(f"Player {self.piece.value} to move: ")
        else:
...
# https://hr.gs/TheAmazonCodingDemo
# https://www.hackerrank.com/test/5fl6sika8gh/c96841d85d1e6863f08430b6f4009e3f
